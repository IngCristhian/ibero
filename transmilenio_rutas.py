...
CONEXIONES_RAW = [
    # Troncal Caracas Norte (Autopista Norte + Caracas)
    # Velocidad comercial: ~23 km/h (Autonorte), ~21 km/h (Caracas centro)
    # Distancia total: ~20 km, 25 estaciones
    # Fuente: Wikipedia ES - TransMilenio, longitud troncales
    ("Portal Norte", "Toberin", "Caracas", 2.5),
    ("Toberin", "Cardio Infantil", "Caracas", 2.0),
    ("Cardio Infantil", "Calle 146", "Caracas", 2.0),
    ("Calle 146", "Calle 142", "Caracas", 1.5),
    ("Calle 142", "Alcala", "Caracas", 2.0),
    ("Alcala", "Prado", "Caracas", 2.0),
    ("Prado", "Calle 127", "Caracas", 2.5),
    ("Calle 127", "Pepe Sierra", "Caracas", 2.0),
    ("Pepe Sierra", "Calle 106", "Caracas", 2.5),
    ("Calle 106", "Calle 100", "Caracas", 2.0),
    ("Calle 100", "Virrey", "Caracas", 2.0),
    ("Virrey", "Calle 85", "Caracas", 2.0),
    ("Calle 85", "Heroes", "Caracas", 2.0),
    ("Heroes", "Calle 72", "Caracas", 2.0),
    ("Calle 72", "Calle 63", "Caracas", 1.5),
    ("Calle 63", "Flores", "Caracas", 1.5),
    ("Flores", "Calle 45", "Caracas", 2.0),
    ("Calle 45", "Marly", "Caracas", 1.5),
    ("Marly", "Calle 34", "Caracas", 2.0),
    ("Calle 34", "Profamilia", "Caracas", 1.5),
    ("Profamilia", "Calle 22", "Caracas", 2.0),
    ("Calle 22", "Calle 19", "Caracas", 1.5),
    ("Calle 19", "Museo Nacional", "Caracas", 1.5),
    ("Museo Nacional", "Centro Memoria", "Caracas", 1.5),
    ("Centro Memoria", "Tercer Milenio", "Caracas", 1.5),

    # Troncal Caracas Sur
    # Velocidad comercial: ~21 km/h, distancia: ~9 km
    # Fuente: TransMilenio oficial - nueva Caracas Sur
    ("Tercer Milenio", "Hospitales", "Caracas Sur", 2.0),
    ("Hospitales", "Nari\u00f1o", "Caracas Sur", 2.0),
    ("Nari\u00f1o", "Restrepo", "Caracas Sur", 2.0),
    ("Restrepo", "Olaya", "Caracas Sur", 2.0),
    ("Olaya", "Quiroga", "Caracas Sur", 2.0),
    ("Quiroga", "Calle 40 Sur", "Caracas Sur", 2.5),
    ("Calle 40 Sur", "General Santander", "Caracas Sur", 2.5),
    ...
    # Fuente: Wikipedia ES - troncal Calle 26
    ("Portal El Dorado", "El Dorado", "Calle 26", 2.0),
    ("El Dorado", "Modelia", "Calle 26", 2.5),
    ("Modelia", "Normandia", "Calle 26", 2.0),
    ("Normandia", "Av 68", "Calle 26", 2.5),
    ("Av 68", "Salitre El Greco", "Calle 26", 2.0),
    ("Salitre El Greco", "CAN", "Calle 26", 2.0),
    ("CAN", "Gobernacion", "Calle 26", 2.0),
    ("Gobernacion", "Calle 63", "Calle 26", 2.0),
    ("Calle 63", "Flores", "Calle 26", 2.0),
    ("Flores", "Calle 22", "Calle 26", 3.0),
    ("Calle 22", "Calle 19", "Calle 26", 1.5),
    ("Calle 19", "Museo Nacional", "Calle 26", 1.5),
    ("Museo Nacional", "San Victorino", "Calle 26", 2.0),
    ("San Victorino", "Las Aguas", "Calle 26", 2.0),

    # Troncal NQS
    # Velocidad comercial: ~22 km/h (pico 20, valle 27)
    # Fuente: TransMilenio 2017 - mejoras NQS
    ("Portal 80", "Polo", "NQS", 3.0),
    ("Polo", "Escuela Militar", "NQS", 2.5),
    ("Escuela Militar", "Av Chile", "NQS", 2.0),
    ("Av Chile", "Calle 63 NQS", "NQS", 2.0),
    ("Calle 63 NQS", "Simon Bolivar", "NQS", 2.5),
    ("Simon Bolivar", "Ricaurte", "NQS", 3.0),
    ("Ricaurte", "Hospitales", "NQS", 2.5),
    ("Hospitales", "NQS Calle 38A Sur", "NQS", 3.0),

    # Troncal Americas
    # Velocidad comercial: ~22 km/h, distancia: ~12.5 km
    # Fuente: Wikipedia ES - troncal Americas
    ("Portal Americas", "Patio Bonito", "Americas", 2.5),
    ("Patio Bonito", "Biblioteca Tintal", "Americas", 2.5),
    ("Biblioteca Tintal", "Mandalay", "Americas", 2.0),
    ("Mandalay", "Mundo Aventura", "Americas", 2.0),
    ("Mundo Aventura", "Marsella", "Americas", 2.5),
    ("Marsella", "Pradera", "Americas", 2.0),
    ("Pradera", "De La Sabana", "Americas", 2.5),
    ("De La Sabana", "Ricaurte", "Americas", 2.0),
    ("Ricaurte", "San Facade", "Americas", 2.0),
    ("San Facade", "Tercer Milenio", "Americas", 2.0),

    # Troncal Suba
    # Velocidad comercial: ~24 km/h, distancia: ~9.5 km
    # Fuente: Wikipedia ES - troncal Suba
    ("Portal Suba", "La Campi\u00f1a", "Suba", 2.5),
    ("La Campi\u00f1a", "Suba TV 91", "Suba", 2.0),
    ("Suba TV 91", "21 Angeles", "Suba", 2.0),
    ("21 Angeles", "Gratamira", "Suba", 2.0),
    ("Gratamira", "Humedal Cordoba", "Suba", 2.0),
    ("Humedal Cordoba", "Shaio", "Suba", 2.0),
    ("Shaio", "Calle 100 Suba", "Suba", 2.0),
    ("Calle 100 Suba", "Calle 100", "Suba", 2.5),
    ("Calle 100", "Heroes", "Suba", 2.5),

    # Troncal Calle 80
    # Velocidad comercial: ~22 km/h (pico 18, valle 28)
    # Fuente: TransMilenio 2017 - mejoras Calle 80
    ("Av Cali Calle 80", "Granja", "Calle 80", 2.5),
    ("Granja", "Minuto de Dios", "Calle 80", 2.0),
    ("Minuto de Dios", "Ferias", "Calle 80", 2.0),
    ("Ferias", "Portal 80", "Calle 80", 2.5),
    ("Portal 80", "Polo", "Calle 80", 3.0),
    ("Polo", "Heroes", "Calle 80", 3.0),
]
